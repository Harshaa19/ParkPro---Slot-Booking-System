...
//     { id: 'manage', label: 'Manage Cars', icon: <FaCar />, path: '/admin/manage-vehicles' },
...
//           <img src="https://i.pravatar.cc/100" alt="Admin" className="rounded-full w-16 h-16" />
//           <h2 className="mt-2 text-sm font-semibold">GreatStack</h2>
//         </div>
...
import React, { useState } from 'react';
import { FaBars, FaPlus, FaCar, FaClipboardList, FaThLarge, FaWarehouse } from 'react-icons/fa';
import { LogOut } from 'lucide-react';
import { useParams, useNavigate } from 'react-router-dom';
...
export default function AdminDashboard2() {
  ...
  const navItems = [
    { id: 'dashboard', label: 'Dashboard', icon: <FaThLarge />, path: '/admin/dashboard' },
    { id: 'create-parking', label: 'Create Parking Lot', icon: <FaWarehouse />, path: '/admin/create-parking' },
    { id: 'manage', label: 'Manage Parking Lot', icon: <FaCar />, path: '/admin/manage-parkinglot' },
    // { id: 'add', label: 'Add Car', icon: <FaPlus />, path: '/admin/add-vehicle' },
    // { id: 'manage', label: 'Manage Cars', icon: <FaCar />, path: '/admin/manage-vehicles' },
    { id: 'bookings', label: 'Manage Bookings', icon: <FaClipboardList />, path: `/hr-admin/${hrId}/bookings` }, 
  ];
