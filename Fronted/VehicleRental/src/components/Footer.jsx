  ...
  return (
    <footer className="bg-[#f0f4ff] text-gray-700 py-16 px-6 md:px-16 lg:px-24">
      <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <h2 className="text-2xl font-bold flex items-center gap-2">
            <span className="text-blue-600 text-3xl">🅿️</span> ParkPro
          </h2>
          <p className="mt-4 text-sm text-gray-500 max-w-xs">
            Hassle-free parking solutions with secure and affordable spots in your city. Reserve in advance and park with peace of mind.
          </p>
          <div className="flex gap-4 mt-6 text-xl text-gray-500">
            <FaFacebookF className="hover:text-blue-600 cursor-pointer" />
            <FaInstagram className="hover:text-pink-500 cursor-pointer" />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:underline">Home</a></li>
            <li><a href="#" className="hover:underline">Find Parking</a></li>
            <li><a href="#" className="hover:underline">List Your Spot</a></li>
            <li><a href="#" className="hover:underline">About Us</a></li>
          </ul>
        </div>
        ...
        <div>
          <h3 className="font-semibold mb-4">CONTACT</h3>
          <ul className="space-y-2 text-sm text-gray-500">
            <li>1234 Parking Lane</li>
            <li>San Francisco, CA 94107</li>
            <li>+1 234 567890</li>
            <li>support@parkpro.com</li>
          </ul>
        </div>
