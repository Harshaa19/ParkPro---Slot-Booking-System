...
const steps = [
  {
    ...
    description: 'Browse nearby parking spots from our extensive network of safe and accessible locations.',
  },
  {
    id: 2,
    icon: <CalendarDays className="w-6 h-6 text-blue-600" />,
    title: 'Choose Date & Time',
    description: 'Pick the exact date and duration that suits your parking needs using our flexible scheduler.',
  },
  {
    id: 3,
    icon: <Bookmark className="w-6 h-6 text-blue-600" />,
    title: 'Reserve Your Spot',
    description: 'Secure your parking space in advance and avoid last-minute hassle.',
  },
];
  ...
  return (
    <section className="bg-[#f0f4ff] py-20 px-6 md:px-16 lg:px-24 text-center">
      ...
      <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12">
        Follow These 3 Simple Steps to Park with <span className='text-orange-600'>Park</span><span className='text-green-600'>Pro</span>
      </h2>
